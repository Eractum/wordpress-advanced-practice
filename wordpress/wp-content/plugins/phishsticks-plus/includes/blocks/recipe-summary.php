...
function up_recipe_summary_render_cb($atts, $content, $block) {
    ...
    $cuisinesString = implode(', ',$cuisines);
    ...
    ob_start();
    ?>
    <div class="wp-block-phishsticks-plus-recipe-summary">
        <i class="bi bi-alarm"></i>
        <div class="recipe-columns-2">
            <div class="recipe-metadata">
                <div class="recipe-title">
                    <?php _e('Prep Time', 'phishsticks-plus'); ?>
                </div>
            ...
            <div class="recipe-metadata">
                <div class="recipe-title">
                    <?php _e('Cook Time', 'phishsticks-plus'); ?>
                </div>
        ...
        <div class="recipe-columns-2-alt">
            <div class="recipe-columns-2">
                <div class="recipe-metadata">
                    <div class="recipe-title">
                        <?php _e('Course', 'phishsticks-plus'); ?>
                    </div>
                ...
                <div class="recipe-metadata">
                    <div class="recipe-title">
                        <?php _e('Cuisine', 'phishsticks-plus'); ?>
                    </div>
                    <div class="recipe-data recipe-cuisine">
                        <p>
                            <?php echo $cuisinesString; ?>
                        </p>
                    </div>
                </div>
            ...
            <div class="recipe-metadata">
                <div class="recipe-title">
                    <?php _e('Rating', 'phishsticks-plus'); ?>
                </div>
                <div
                    class="recipe-data" id="recipe-rating"
